...
####################################################
	...
	def gui_init(self):
		...
		self.entryFile.insert ( 0, 'random_7' )
		...
		self.entryNumSensors   .insert ( 0, '200')
		self.entryOrigin       .insert ( 0, '-2.094395' )
		self.entryRange        .insert ( 0, '4.18879' )
		self.entryValue        .insert ( 0, '5' )
